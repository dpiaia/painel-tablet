...
controle, que é a única tela que trocava tema. Agora a tela de créditos do
TABLET também troca — e duas cópias da mesma tabela em dois arquivos JS
...
LISTA = [
    {"nome": "Escuro", "slug": "escuro", "cor": "#22d3ee", "cores": dict(PADRAO)},

    {"nome": "Claro", "slug": "claro", "cor": "#2563eb", "cores": {
    ...
    {"nome": "Apple", "slug": "apple", "cor": "#0071e3", "cores": {
    ...
    {"nome": "Orkut", "slug": "orkut", "cor": "#c0187a", "cores": {
    ...
    {"nome": "Facebook", "slug": "facebook", "cor": "#3b5998", "cores": {
    ...
    {"nome": "Windows XP", "slug": "xp", "cor": "#245edb", "cores": {
    ...
    # avisou.
    {"nome": "Matrix", "slug": "matrix", "cor": "#39ff14", "cores": {
    ...
    {"nome": "Windows 95", "slug": "win95", "cor": "#008080", "cores": {
